...
const Work = () => {
    return (
      <div name='work' className='w-full h-full md:h-screen text-slate-800 bg-orange-100 dark:text-gray-300 dark:bg-slate-900 md:pt-10 md:pb-10'>

        <div className='max-w-[800px] mx-auto p-4 flex flex-col justify-center w-full h-screen'>

          <div className='pb-8'>
            <p className='text-4xl font-bold inline border-b-4 text-slate-800 dark:text-gray-300 border-sky-300'>
              Work
            </p>
            <p className='py-6'>// Some of my personal projects</p>
          </div>
